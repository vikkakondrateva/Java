...
public class lab1java extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        double lowerLimit = Double.parseDouble(jTable1.getValueAt(currentRow, 0).toString());
        double upperLimit = Double.parseDouble(jTable1.getValueAt(currentRow, 1).toString());
        double step = Double.parseDouble(jTable1.getValueAt(currentRow, 2).toString());
